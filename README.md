...
* ATtiny 4/5/10/11 and any other "AVRrc" (reduced core) parts, these combine miniscule memory sizes with a gimped CPU. [Try this core](https://github.com/technoblogy/attiny10core)
...
The classic tinyAVR parts are a motley bunch - some of them are very mundane, with little to distinguish them other than the fact that they just work like you'd expect, while others are just bizzare. The part specific documentation covers most of the relevant topics that apply specifically to a given family of parts.
...
Micronucleus boards have highly constained options for clock speed, and the exact parameters depend on the part - refer to the part-specific documentation for more information.
Internal:
* 8 MHz
* 1 MHz
