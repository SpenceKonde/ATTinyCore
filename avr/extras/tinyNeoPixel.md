...
## tinyNeoPixel Port menu option REMOVED from 2.0.0
...
Moreover the second one, using the `<tinyNeoPixel.h>` version of the library, does not report the RAM used for the buffer: 300 bytes, more than most of the ATTinyCore parts have in total.
