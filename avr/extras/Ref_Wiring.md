...
It is recommended that you install a 1x6 pin FTDI header for ease of connection to a serial adapter if using Optiboot, or in general if you plan to use the serial port. . The pinout of this is:
1. Gnd
2. Not used
3. Vcc
