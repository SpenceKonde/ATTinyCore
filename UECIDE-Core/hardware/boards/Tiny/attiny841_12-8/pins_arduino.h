...
//Define the values for the TOCPMSA register
#define TOCPMSA1_INIT (_BV(TOCC5S0))
#define TOCPMSA0_INIT (_BV(TOCC2S0) | _BV(TOCC1S1) | _BV(TOCC0S1))
...
//       INT0  (D  1)  PB1  3|    |12  PA1  (D  9)        PWM
//             (D 11)  PB3  4|    |11  PA2  (D  8)        PWM
//  PWM  RXD0  (D  2)  PB2  5|    |10  PA3  (D  7)        PWM
//  PWM  TXD0  (D  3)  PA7  6|    |9   PA4  (D  6) RXD1   
//  PWM        (D  4)  PA6  7|    |8   PA5  (D  5) RXD1   
//                           +----+
