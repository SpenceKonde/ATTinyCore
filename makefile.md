...
Board names ending in micr are for use with the Micronucleus (digispark) bootloader. Only parts with at least 8k of flash are supported for this bootloader.
