...
The Micronucleus bootloader for these parts uses a 16 MHz external clock source. Boards are commercially available (and cheap) under the name MH Tiny (also MH ET and several other names). USB is on pins 1 and 2, and the LED is on pin 0.
